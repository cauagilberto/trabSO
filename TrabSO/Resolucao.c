...
void rodar_bateria_overhead_20k() {
    tam_linhas = 20000; tam_colunas = 20000; usa_mutex = 1;
    macro_linhas = 1000; macro_colunas = 1000;
    ...
    printf("\nMATRIZES 20.000X20.000 (Modo Atual Detectado: x64):\n- overhead(x64):\n");
#else
    printf("\nMATRIZES 20.000X20.000 (Modo Atual Detectado: x86):\n- overhead(x86):\n");
#endif

    printf("\t- macrobloco %dx%d:\n", macro_linhas, macro_colunas);
    gera_aloca_matriz(tam_linhas, tam_colunas);
    busca_serial(); // Serial de base para a matriz de 20k
